...
static const lv_image_dsc_t *owl_frames[5] = {
    &owl_frame_open,
    &owl_frame_open,
    &owl_frame_half,
    &owl_frame_closed,
...
static const lv_image_dsc_t *moon_frames[3] = {
    &moon_frame_1,
    &moon_frame_2,
    &moon_frame_3,
};
...
lv_obj_t *zmk_display_status_screen() {
    ...
    lv_animimg_set_duration(moon, 4500);
